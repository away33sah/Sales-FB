...
def AturUser():
    Console(width=5000).print(Panel(f'[bold green][[bold white]*[bold green]] [bold white]Total id : {len(ID)}',style='bold purple'))
...
[bold green][[bold white]3[bold green]]. [bold white]Crack dari ID random''') ; Console(width=5000).print(Panel(exec ,style='bold purple'))
