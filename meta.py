...
def login_cookie():
    ...
    try:
        ...
        header = {"Host":"m.facebook.com", "origin":"https://m.facebook.com", "upgrade-insecure-requests" : "1",
        ...
        if 'c_user' in session.cookies.get_dict():
            ...
            #ikeh = ewee.get('ikeh')
            token = ewee.get('token')
            nama = session.get("https://m.facebook.com/me?access_token={token}").json()["name"]
